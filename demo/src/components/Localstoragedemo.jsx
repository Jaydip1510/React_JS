...
const Localstoragedemo = () => {
  ...
  return (
    <div className='App'>
      ...
      <table border={2} align='center' className='bg-secondary' cellPadding={0} cellSpacing={0} style={{height:500,width:600}} >

        <label htmlFor="" style={{ marginRight: 10,color:"blue",fontWeight:"bold" }} className='mb-2'>Name:-</label>
        ...
        <label htmlFor="" style={{ marginRight: 25,color:"blue",fontWeight:"bold" }} className='mb-2'>Age:-</label>
        <input type="text" name="age" style={{height:35,width:200}} value={age} onChange={(e)=>setAge(e.target.value)} placeholder='Enter Your Age' />
        <br/><br/> 

        <label htmlFor="" style={{ marginRight: 10,color:"blue",fontWeight:"bold" }} className='mb-2'>Salary:-</label>
        ...
        <label htmlFor="" style={{ marginRight: 15,color:"blue",fontWeight:"bold" }} className='mb-2'>Email:-</label>
        ...
        <label htmlFor="" style={{ marginRight: 25,color:"blue",fontWeight:"bold" }}>Add:-</label>
        ...
        <label htmlFor="" style={{marginLeft:15,color:"blue",fontWeight:"bold" }}>Qualification:-</label>
