            ...
            <div className='row'>
                <div className='col-5 bg-secondary'>
                    <form action="" className="text-center mt-5 text-primary" >
                        <label htmlFor="fname" style={{width:100,textAlign:"center"}} >Name : </label>
                        <input type="text" name="fname" style={{height:35,width:250}} placeholder="Enter Your  Name" value={info.fname} onChange={Handlechange} />
                        <br /><br />
                        <label htmlFor="email" style={{width:100,textAlign:"center"}}>Email :</label>
                        ...
                        <br /><br />
                        <label htmlFor="psw" style={{width:100,textAlign:"center"}} >Password :</label>
                        ...
                        <br /><br />
                        <label htmlFor="add" style={{width:100,textAlign:"center"}} >Address : </label>
                        ...
                        <br /><br />
                        <label htmlFor="mno" style={{width:100,textAlign:"center"}}>Number : </label>
